...
class VendedorController extends BaseController
{
    ...
    {
        $response = Http::get('http://localhost:8080/vendedores');
    ...
    {
        $response = Http::post('http://localhost:8080/vendedores/store', [
    ...
    {
        $response = Http::get('http://localhost:8080/vendedores/' . $id);
